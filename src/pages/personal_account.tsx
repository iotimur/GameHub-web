                ...
                <div className="block2">
                    ...
                    <div className="shops">
                        <div className="left d-flex">
                            ...
                            <div className="d-f">
                                <p>Дата покупки: 18.01.24 Сумма: 300 руб. Статус: оплачено</p>
                            </div>  
                            <div>
                                <img src={game22} alt="game2_photo"/>
                            </div>
                            <div className="d-f">
                                <p>Дата покупки: 13.02.24 Сумма: 300 руб. Статус: оплачено</p>
                            </div>  
                ...
                <div className="block3">
                    ...
                    <div className="d-flex">
                        <div className="links">
                            ...
                            <p>Вот некоторые данные, которые можно изменить в профиле: имя, фамилия, номер телефона, Email. </p>
