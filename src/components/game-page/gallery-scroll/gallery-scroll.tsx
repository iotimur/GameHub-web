...
const Gallery = ({ openModal }) => {
  ...
  const handleBackClick = () => {
    setIndex(
      (prevIndex) => (prevIndex - 3 + screenshots.length) % screenshots.length
    );
  };
  ...
  return (
    <GalleryContainer>
      ...
      <ScrollButton className="btn-scroll left-btn" onClick={handleBackClick}>
        &#9664;&#xFE0E;
      </ScrollButton>
      <ScrollButton className="btn-scroll right-btn" onClick={handleNextClick}>
        &#9654;&#xFE0E;
      </ScrollButton>
    </GalleryContainer>
  );
