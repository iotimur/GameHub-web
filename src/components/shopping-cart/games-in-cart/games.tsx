...
const Games = () => {
    return (
       ...
       <Oval>Ваша корзина</Oval>
            <Container_my>
                <BigImage src={mortal} alt="Игра Мортал Комбат. Змея." style={{ marginTop: "4.5vh" }} />
            ...
            <Container_my>
                <BigImage src={fifa} alt="Игра Фифа 23." style={{ marginTop: "4.5vh" }} />
            ...
            <Container_my>
                <BigImage src={ved} alt="Игра в Ведьмака." style={{ marginTop: "4.5vh" }} />
